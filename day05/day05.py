...
def main():
    ...
    print('After all possible reactions, the resulting polymer contain {} '
          'units'.format(len(polymer1)))
    ...
    print('After removing this unit, the length of the fully reacted polymer '
          'is: {}'.format(minlen))
